...
feat = feat_import.iloc[:50, 0].tolist()
...
if True:
    ...
    for n in [5, 10, 15, 20, 30, 40, 50]:
        ...
        clfs.runKfold(AdaBoostClassifier, {"n_estimators": [100, 200, 300, 400, 500, 1000], 'learning_rate': [0.0001, 0.001, 0.01, 0.1, 1]}, True)

        # print(clfs.clf_eval)
        clfs.clf_eval.to_excel("report/adaboost_feat%r_eval.xlsx" %(n))
elif False:
    file = "feat"
    for n in [3, 5, 7, 10, 15, 20]:
        ...
        # print(clfs.clf_eval)
        clfs.clf_eval.to_excel("report/feat_%r_eval.xlsx" %(n))
else:
